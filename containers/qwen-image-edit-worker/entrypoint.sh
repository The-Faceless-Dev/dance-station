...
echo "QWEN EDIT startup user=$(id -un) uid=$(id -u) home=${HOME} cache=${XDG_CACHE_HOME} backend=${QWEN_IMAGE_EDIT_RUNTIME:-diffusers}"
...
/opt/qwen-image-edit-venv/bin/python -m autotransition.qwen_image_edit.server &
WORKER_PID=$!
